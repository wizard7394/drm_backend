...
class AppErrors:
    ...
    ACCOUNT_SUSPENDED = HTTPException(
        status_code=status.HTTP_403_FORBIDDEN, detail="account_has_been_suspended"
    )
    IDENTIFIER_ALREADY_EXISTS = HTTPException(
        status_code=status.HTTP_409_CONFLICT,
        detail="email_or_mobile_already_registered",
    )

    # ==========================================
    # Hardware & Device Security Errors
    # ==========================================
    ...
    TOO_MANY_REQUESTS = HTTPException(
        ...
        detail="too_many_requests_ip_rate_limited",
    )
    ...
    # ==========================================
    # Course & License Management Errors
    # ==========================================
